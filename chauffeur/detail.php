            ...
            <section id="content_wrapper">
                ...
                <header id="topbar">
                    ...
                    <div class="topbar-right">
                        ...
                        <a href="../chauffeur/add.php" class="btn btn-danger btn-sm fw600 ml10 btn-gradient btn-rounded"><span class="fa fa-user-plus pr5"></span> Ajouter chauffeur</a>
                    ...
                    <div class="tray tray-center p25 va-t posr">
                        ...
                        <div class="panel mb25 mt5">
                            <div class="panel-heading">
                                <span class="panel-title"><span class="fa fa-leanpub pr5"></span> Information(s) générale(s) sur un chauffeur</span>
                                            ...
                                            <div class="col-lg-3">
                                                    ...
                                                    <div style="margin: 0 auto; width: 90%;">
                                                        <div class="fileupload fileupload-new admin-form" data-provides="fileupload">
                                                            <div class="fileupload-preview thumbnail mb15">
                                                                <img data-src="holder.js/100%x147" src="/hprofil-ak-xat1/images/" alt="holder">
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <ul class="fs14 list-unstyled list-spacing-10 mb10 pl5">
                                                                    ...
                                                                    <li>
                                                                        <i class="fa fa-exclamation-circle text-success fa-lg pr10"></i>
                                                                        Chauffeur<b> disponible</b>
                                                                    </li> 
                                                                    <li>
                                                                        <i class="fa fa-exclamation-circle text-danger fa-lg pr10"></i>
                                                                        Chauffeur<b> non disponible</b>
                                                                    </li>
                                                         
                                                        <li>
                                                            <a href="javascript:void(0)">
                                                                <span>
                                                                    <i class="fa fa-plus-circle text-warning fa-lg pr10"></i>
                                                            <b> Assigner véhicule</b>
                                                                </span>
                                                            </a>
                                                            </a>
                                                        </li>
                                            ...
                                            <div class="col-lg-9">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <h6 style="margin: 0;">Identité du chauffeur</h6>
                                                        <br/>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label>Matricule </label>
                                                                    <input type="text" value="" class="form-control required" disabled>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <h5 class="text-info" style="margin: 0;">Assignation véhicule</h5>
                                                        <h6 style="margin: 0;">Véhicule presentement assigné au chauffeur.</h6>
                                                        <br/>
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <div class="form-group">
