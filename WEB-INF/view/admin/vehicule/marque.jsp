...
<html>
    ...
    <body class="dashboard-page sb-l-o sb-r-c">
                ...
                <header id="topbar">
                    <div class="topbar-left">
                        <ul class="nav nav-list nav-list-topbar pull-left">
                            ...
                            <%--<li>
                                <a href="../vehicule/modele">Marques</a>
                            </li>
                            <li>
                    ...
                    <div class="tray tray-center p25 va-t posr">
                        ...
                        <div class="panel mb25 mt5">
                            <div class="panel-heading">
                                <span class="panel-title"><span class="fa fa-car pr5"></span> Gestion des marques</span>
                                                        ...
                                                        <form action="manager/vehicule/marque" method="post">
                                                            ...
                                                            <h6 style="margin: 0;">Les champs précédés du caractère astérisque (*) sont obligatoires</6>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="userName" name="marq" type="text" class="form-control required">
                                                                </div> 
                                                                <div class="form-group">
                                                                ...
                                                                <input type="hidden" name="section" value="marque" />
                                                ...
                                                <div class="panel" id="spy4">
                                                    <div class="panel-heading" style="padding:0;">
                                                        <span class="panel-title">
                                                            <span class="glyphicons glyphicons-table"></span>Liste des marques</span>
        ...
        <script>
            var CONTEXT_MSG_ADD_MARQUE = '<% if (session.getAttribute("isAddMarque") != null) {
                    out.print(session.getAttribute("isAddMarque").toString());
                    session.removeAttribute("isAddMarque");
                }%>';
        </script>
...
<script src="../../../../vendor/plugins/chosen/chosen.jquery.js"></script>
        ...
        <script type="text/javascript">
            jQuery(document).ready(function () {
                ...
                if (CONTEXT_MSG_ADD_MARQUE !== "") {

                    var $noteStyle ='';
                    var $msg='';
                    if(CONTEXT_MSG_ADD_MARQUE === "-1"){
                        $noteStyle="danger";
                        $msg="Echec de l'opération...";
                    }else if(CONTEXT_MSG_ADD_MARQUE === "0"){
                        $noteStyle="warning";
                        $msg="Exception, la marque existe déjà";
                    }else if(CONTEXT_MSG_ADD_MARQUE === "1"){
                        $noteStyle="success";
                        $msg="marque ajoutée avec succès!!!";
                    }
