...
<html>
    ...
    <body class="dashboard-page sb-l-o sb-r-c">
        ...
        List<Modele> listModele = modeleService.FindAll();
        %>
            ...
            <section id="content_wrapper">
                ...
                <header id="topbar">
                    ...
                    <div class="topbar-right">
                        <a href="../vehicule/carrosserie" class="btn btn-danger btn-sm fw600 ml10 btn-gradient btn-rounded"><span class="fa fa-plus pr5"></span> Ajouter Catégorie</a>
                    ...
                    <div class="tray tray-center p25 va-t posr">
                        ...
                        <div class="panel mb25 mt5">
                            <div class="panel-heading">
                                <span class="panel-title"><span class="fa fa-car pr5"></span> Gestion des modèles</span>
                                                ...
                                                <div class="col-md-4" style="margin-top: 10px;">
                                                    ...
                                                    <div class="panel" id="p13" data-panel-fullscreen="false" data-panel-title="false" data-panel-remove="false" data-panel-collapse="false">
                                                        <div class="panel-heading ui-sortable-handle">
                                                            <span class="panel-title"> Ajouter un modèle de véhicule</span>
                                                        </div>
                                ...
                                <form action="manager/vehicule/modele" method="post">
                                                            ...
                                                            <h6 style="margin: 0;">Les champs précédés du caractère astérisque (*) sont obligatoires</h6>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="marque" class="chosen-select form-control">
                                                                        <option value=""> </option>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input id="modele" name="modele" type="text" class="form-control required">
                                                                </div>
                                    ...
                                    <input type="hidden" name="section" value="modele" />
                                                    ...
                                                    <div class="panel" id="spy4">
                                                        <div class="panel-heading" style="padding:0;">
                                                            <span class="panel-title">
                                                                <span class="glyphicons glyphicons-table"></span>Liste des modèles</span>
                                                                ...
                                                                <table class="table table-bordered mbn" id="datatable2">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            try{
                                                                                if(mo.getId()!=null){
                                                                                    out.println(mo.getMarque().getLibelle());
                                                                                }
                                                                            }catch(Exception e){   
                                                                            }
                                                                            %>
        ...
        <script>
            var CONTEXT_MSG_ADD_MODELE = '<% if (session.getAttribute("isAddModele") != null) {
                    out.print(session.getAttribute("isAddModele").toString());
                    session.removeAttribute("isAddModele");
                }%>';
        </script>
...
<script src="../../../../vendor/plugins/chosen/chosen.jquery.js"></script>
        ...
        <script type="text/javascript">
            jQuery(document).ready(function () {
                ...
                if (CONTEXT_MSG_ADD_MODELE !== "") {

                    var $noteStyle ='';
                    var $msg='';
                    if(CONTEXT_MSG_ADD_MODELE === "-1"){
                        $noteStyle="danger";
                        $msg="Echec de l'opération...";
                    }else if(CONTEXT_MSG_ADD_MODELE === "0"){
                        $noteStyle="warning";
                        $msg="Exception, le modèle existe déjà";
                    }else if(CONTEXT_MSG_ADD_MODELE === "1"){
                        $noteStyle="success";
