...
<html>
    ...
    <body class="dashboard-page sb-l-o sb-r-c">
        ...
        <%
            PuissanceFiscaleService puissanceFiscaleService = new PuissanceFiscaleService();
            List<PuissanceFiscale> listPuissanceFiscale = puissanceFiscaleService.FindAll();
        ...
        <div id="main">
                ...
                <header id="topbar">
                    <div class="topbar-left">
                        <ul class="nav nav-list nav-list-topbar pull-left">
                            ...
                            --%>
                            <li class="active">
                                <a href="javascript:void(0);">Puissance Fiscale</a>
                            </li>
                            <%--<li>
                    ...
                    <div class="tray tray-center p25 va-t posr">
                        ...
                        <div class="panel mb25 mt5">
                            <div class="panel-heading">
                                <span class="panel-title"><span class="fa fa-car pr5"></span> Gestion des puissances fiscales</span>
                            ...
                            <div class="panel-body p20 pb10">
                                ...
                                <div class="tab-content pn br-n admin-form">
                                    ...
                                    <div id="tab1_1" class="tab-pane active">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="panel" id="p13" data-panel-fullscreen="false" data-panel-title="false" data-panel-remove="false" data-panel-collapse="false">
                                                    <div class="panel-heading ui-sortable-handle">
                                                        <span class="panel-title">Enregistrement de puissance fiscale</span>
                                                        <span class="panel-controls"><a href="#" class="panel-control-loader"></a><a href="#" class="panel-control-color"></a></span></div>
                                                    <div class="panel-body">

                                                        <form action="manager/parameter/puissance" method="post">
                                                ...
                                                <div class="panel" id="spy4">
                                                    <div class="panel-heading" style="padding:0;">
                                                        <span class="panel-title">
                                                            <span class="glyphicons glyphicons-table"></span>Liste des puissances fiscales </span>
                                                    ...
                                                    <div class="panel-body pn">
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered mbn" id="datatable2">
                                                                ...
                                                                <tbody>
                                                                    <% int i=1; %>
                                                                    <% for (PuissanceFiscale mo : listPuissanceFiscale) { %>
                                                                    <% if (mo.getActive() == 1) { %>
                                                                    <tr class="text-center">
                                                                        <td>
                                                                            <%
                                                                        ...
                                                                        <td>
                                                                            <button type="button" class="btn btn-xs btn-default active-animation" ref-id="<%= mo.getId() %>" ref-lib="<%= mo.getLibelle() %>" ref-form="#modal-form-puissance" data-effect="mfp-sign"><i class="fa fa-edit"></i>
                                                                            </button>
                                                                        </td>
                                                                    </tr>
                                                                    <% i++; %>
                                        ...
                                        <input type="hidden" name="action" value="puissance" />
                                        <input type="hidden" name="section" value="puissance" />
            ...
            <div class="row">
                ...
                <div id="modal-form-puissance" class=" popup-basic admin-form mfp-with-anim mfp-hide" style="width:350px; max-width: none;">
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title"><i class="fa fa-edit"></i>Modification puissance fiscale</span>
                        </div>
                        <!-- end .panel-heading section -->

                        <form method="post" action="manager/parameter/puissance" id="comment" enctype="multipart/form-data">
                            <div class="panel-body p25">
                                ...
                                <div class="section row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label style="color: #E9573F;">Entrez le nouveau libellé</label>
                    ...
                    <input type="hidden" value="" name="id_puissance" id="id_puissance" />
                    <input type="hidden" name="action" value="puissance" />
                    <input type="hidden" name="section" value="puissance" />
