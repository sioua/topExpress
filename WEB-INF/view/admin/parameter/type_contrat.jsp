...
<html>
    ...
    <body class="dashboard-page sb-l-o sb-r-c">
        ...
        <%
            TypeContratService typeContratService = new TypeContratService();
            List<TypeContrat> listTypeContrat = typeContratService.FindAll();
                ...
                <header id="topbar">
                    <div class="topbar-left">
                        <ul class="nav nav-list nav-list-topbar pull-left">
                            ...
                            --%>
                            <li class="active">
                                <a href="javascript:void(0);">Type de Contrat</a>
                            </li>
                            <%--<li>
                    ...
                    <div class="tray tray-center p25 va-t posr">
                        ...
                        <div class="panel mb25 mt5">
                            <div class="panel-heading">
                                <span class="panel-title"><span class="fa fa-car pr5"></span> Gestion des types de contrat</span>
                            ...
                            <div class="panel-body p20 pb10">
                                ...
                                <div class="tab-content pn br-n admin-form">
                                    ...
                                    <div id="tab1_1" class="tab-pane active">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="panel" id="p13" data-panel-fullscreen="false" data-panel-title="false" data-panel-remove="false" data-panel-collapse="false">
                                                    <div class="panel-heading ui-sortable-handle">
                                                        <span class="panel-title">Enregistrer un type de contrat</span>
                                                        <span class="panel-controls"><a href="#" class="panel-control-loader"></a><a href="#" class="panel-control-color"></a></span></div>
                                                    <div class="panel-body">

                                                        <form action="manager/parameter/type_contrat" method="post">
                                                ...
                                                <div class="panel" id="spy4">
                                                    <div class="panel-heading" style="padding:0;">
                                                        <span class="panel-title">
                                                            <span class="glyphicons glyphicons-table"></span>Les Types de Contrat </span>
                                                    ...
                                                    <div class="panel-body pn">
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered mbn" id="datatable2">
                                                                ...
                                                                <tbody>
                                                                    <% for (TypeContrat mo : listTypeContrat) { %>
                                                                    <tr class="text-center">
                                                                        <td>
                                                                            <%
                                                                                try {
                                        ...
                                        <input type="hidden" name="action" value="type_contrat" />
                                        <input type="hidden" name="section" value="type_contrat" />
