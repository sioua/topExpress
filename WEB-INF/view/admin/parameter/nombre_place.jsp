...
<html>
    ...
    <body class="dashboard-page sb-l-o sb-r-c">
        ...
        <%
            NombrePlaceService nombrePlaceService = new NombrePlaceService();
            List<NombrePlace> listNombrePlace = nombrePlaceService.FindAll();
        ...
        <div id="main">
                ...
                <header id="topbar">
                    <div class="topbar-left">
                        <ul class="nav nav-list nav-list-topbar pull-left">
                            ...
                            --%>
                            <li class="active">
                                <a href="javascript:void(0);">Nombre de place</a>
                            </li>
                            <%--<li>
                    ...
                    <div class="tray tray-center p25 va-t posr">
                        ...
                        <div class="panel mb25 mt5">
                            <div class="panel-heading">
                                <span class="panel-title"><span class="fa fa-car pr5"></span> Gestion des nombres de places</span>
                            ...
                            <div class="panel-body p20 pb10">
                                ...
                                <div class="tab-content pn br-n admin-form">
                                    ...
                                    <div id="tab1_1" class="tab-pane active">
                                                ...
                                                <div class="panel" id="spy4">
                                                    <div class="panel-heading" style="padding:0;">
                                                        <span class="panel-title">
                                                            <span class="glyphicons glyphicons-table"></span>Nombres de place </span>
                                                    ...
                                                    <div class="panel-body pn">
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered mbn" id="datatable2">
                                                                ...
                                                                <tbody>
                                                                        <% int i=1; %>
                                                                    <% for (NombrePlace mo : listNombrePlace) { %>
                                                                    <% if (mo.getActive() == 1) { %>
                                                                    <tr class="text-center">
                                                                        <td>
                                                                            <%
                                                                        ...
                                                                        <td>
                                                                            <button type="button" class="btn btn-xs btn-default active-animation" ref-id="<%= mo.getId() %>" ref-lib="<%= mo.getLibelle() %>" ref-form="#modal-form-place" data-effect="mfp-sign"><i class="fa fa-edit"></i>
                                                                            </button>
                                                                        </td>
                                                                    </tr>
                                                                    <% i++; %>
                                        ...
                                        <input type="hidden" name="section" value="place" />
            ...
            <div class="row">
                ...
                <div id="modal-form-place" class=" popup-basic admin-form mfp-with-anim mfp-hide" style="width:350px; max-width: none;">
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title"><i class="fa fa-edit"></i>Modification de nombre de place</span>
                        </div>
                        <!-- end .panel-heading section -->

                        <form method="post" action="manager/parameter/nombre_place" id="comment" enctype="multipart/form-data">
                            <div class="panel-body p25">
                                ...
                                <div class="section row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label style="color: #E9573F;">Le nombre de places</label>
                    ...
                    <input type="hidden" value="" name="id_place" id="id_place" />
                    <input type="hidden" name="action" value="place" />
                    <input type="hidden" name="section" value="place" />
