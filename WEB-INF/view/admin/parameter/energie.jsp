...
<html>
    ...
    <body class="dashboard-page sb-l-o sb-r-c">
        ...
        <%
            ParamEnergieService energieService = new ParamEnergieService();
            List<ParamEnergie> listEnergie = energieService.FindAll();
        ...
        <div id="main">
                ...
                <header id="topbar">
                    <div class="topbar-left">
                        <ul class="nav nav-list nav-list-topbar pull-left">
                            ...
                            --%>
                            <li class="active">
                                <a href="javascript:void(0);">Energie</a>
                            </li>
                            <%--<li>
                    ...
                    <div class="tray tray-center p25 va-t posr">
                        ...
                        <div class="panel mb25 mt5">
                            <div class="panel-heading">
                                <span class="panel-title"><span class="fa fa-car pr5"></span> Gestion des energies</span>
                            ...
                            <div class="panel-body p20 pb10">
                                ...
                                <div class="tab-content pn br-n admin-form">
                                    ...
                                    <div id="tab1_1" class="tab-pane active">
                                                                ...
                                                                <div class="col-md-12" style="margin-top:30px;">
                                                                    <div class="row">
                                                                        <div class="col-md-12">
                                                                            <div class="form-group">
                                                                                <label>Libelle *</label>
                                                                                <input id="libelle" name="libelle" type="text" class="form-control required br-dark">
                                                                            </div>
                                                                        </div>
                                                                    </div>  
                                                ...
                                                <div class="panel" id="spy4">
                                                    <div class="panel-heading" style="padding:0;">
                                                        <span class="panel-title">
                                                            <span class="glyphicons glyphicons-table"></span>Liste des energies </span>
                                                    ...
                                                    <div class="panel-body pn">
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered mbn" id="datatable2">
                                                                ...
                                                                <tbody>
                                                                    <% int i=1; %>
                                                                    <% for (ParamEnergie mo : listEnergie) { %>
                                                                    <% if (mo.getActive() == 1) { %>
                                                                    <tr class="text-center">
                                                                        <td>
                                                                            <%
                                        ...
                                        <input type="hidden" name="action" value="energie" />
                                        <input type="hidden" name="section" value="energie" />
            ...
            <div class="row">
                ...
                <div id="modal-form-energie" class=" popup-basic admin-form mfp-with-anim mfp-hide" style="width:350px; max-width: none;">
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title"><i class="fa fa-edit"></i>Modification energie</span>
                        </div>
                        <!-- end .panel-heading section -->

                        <form method="post" action="manager/parameter/energie" id="comment" enctype="multipart/form-data">
                    ...
                    <input type="hidden" value="" name="id_energie" id="id_energie"></input>
                    <input type="hidden" value="energie" name="action"></input>
                    <input type="hidden" value="energie" name="section"></input>
                    <input type="hidden" value="edit" name="operation"></input>
                    </form>
                </div>            
