...
<html>
    ...
    <body class="dashboard-page sb-l-o sb-r-c">
        ...
        <%
            SiteAffectationService siteAffectationService = new SiteAffectationService();
            List<Parking> listSiteAffectation = siteAffectationService.FindAll();
        ...
        <div id="main">
                ...
                <header id="topbar">
                    <div class="topbar-left">
                        <ul class="nav nav-list nav-list-topbar pull-left">
                            ...
                            --%>
                            <li class="active">
                                <a href="javascript:void(0);">Site d'affectation</a>
                            </li>
                            <%--<li>
                    ...
                    <div class="tray tray-center p25 va-t posr">
                        ...
                        <div class="panel mb25 mt5">
                            <div class="panel-heading">
                                <span class="panel-title"><span class="fa fa-car pr5"></span> Gestion des sites d'affectation</span>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="panel" id="p13" data-panel-fullscreen="false" data-panel-title="false" data-panel-remove="false" data-panel-collapse="false">
                                                    <div class="panel-heading ui-sortable-handle">
                                                        <span class="panel-title">Enregistrement de site d'affectation</span>
                                                        <span class="panel-controls"><a href="#" class="panel-control-loader"></a><a href="#" class="panel-control-color"></a></span></div>
                                                    <div class="panel-body">

                                                        <form action="manager/parameter/site" method="post">
                                                ...
                                                <div class="panel" id="spy4">
                                                    <div class="panel-heading" style="padding:0;">
                                                        <span class="panel-title">
                                                            <span class="glyphicons glyphicons-table"></span>Liste des sites d'affectation </span>
                                                    ...
                                                    <div class="panel-body pn">
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered mbn" id="datatable2">
                                                                ...
                                                                <tbody>
                                                                    <% int i=1; %>
                                                                    <% for (Parking mo : listSiteAffectation) { %>
                                                                    <% if (mo.getActive() == 1) { %>
                                                                    <tr class="text-center">
                                                                        <td>
                                                                            <%
                                                                        ...
                                                                        <td>
                                                                            <button type="button" class="btn btn-xs btn-default active-animation" ref-id="<%= mo.getId() %>" ref-lib="<%= mo.getLibelle() %>" ref-form="#modal-form-site" data-effect="mfp-sign"><i class="fa fa-edit"></i>
                                                                            </button>
                                                                        </td>
                                                                    </tr>
                                                                    <% i++; %>
            ...
            <div class="row">
                ...
                <div id="modal-form-site" class=" popup-basic admin-form mfp-with-anim mfp-hide" style="width:350px; max-width: none;">
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title"><i class="fa fa-edit"></i>Modification du site</span>
                        </div>
                        <!-- end .panel-heading section -->

                        <form method="post" action="manager/parameter/site" id="comment" enctype="multipart/form-data">
                            <div class="panel-body p25">
                                ...
                                <div class="section row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Ancien nom du site</label>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label style="color: #E9573F;">Entrez le nouveau nom du site</label>
