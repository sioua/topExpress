    ...
    <body class="dashboard-page sb-l-o sb-r-c">
        ...
        <div id="main">
                    ...
                    <div class="tray tray-center p25 va-t posr">
                        ...
                        <div class="panel mb25 mt5">
                            <div class="panel-heading">
                                <span class="panel-title"><span class="fa fa-car pr5"></span> Gestion des directions</span>
                                            ...
                                            <div class="col-md-12" >
                                                ...
                                                <div class="panel" id="p13" data-panel-fullscreen="false" data-panel-title="false" data-panel-remove="false" data-panel-collapse="false">
                                                    <div class="panel-heading ui-sortable-handle">
                                                        <span class="panel-title">Création de direction</span>
                                                        <span class="panel-controls"><a href="#" class="panel-control-loader"></a><a href="#" class="panel-control-color"></a></span></div>
                                                    <div class="panel-body">

                                                        <form action="admin/organisation/direction/add.php" method="post">
                                                            ...
                                                            <input type="hidden" name="section" value="direction" />
                                                ...
                                                <div class="panel" id="spy4">
                                                    <div class="panel-heading" style="padding:0;">
                                                        <span class="panel-title">
                                                            <span class="glyphicons glyphicons-table"></span>Liste des directions </span>
                                                    ...
                                                    <div class="panel-body pn">
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered mbn" id="datatable2">
                                                                ...
                                                                <tbody>
                                                                    <% int i = 1; %>
                                                                    <% for (OrgDirection mo : listDirection) { %>
                                                                    <% if(mo.getActive() ==1) { %>
                                                                    <tr class="text-center">
                                                                        <td>
                                                                            <%
                                                                        ...
                                                                        <td>
                                                                            <button type="button" class="btn btn-xs btn-default active-animation" ref-id="<%= mo.getId() %>" ref-lib="<%= mo.getLibelle() %>"  ref-man="<% if(mo.getChef()!=null){out.print(mo.getChef().getNom()+" "+mo.getChef().getPrenom());} %>" ref-man-id="<% if(mo.getChef()!=null){out.print(mo.getChef().getId());} %>" ref-form="#modal-form-direction" data-effect="mfp-sign"><i class="fa fa-edit"></i>
                                                                            </button>
                                                                        </td>
                                                                    </tr>
                                                                    <% i++; %>
            ...
            <div class="row">
                ...
                <div id="modal-form-direction" class=" popup-basic admin-form mfp-with-anim mfp-hide" style="width:550px; max-width: none;">
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title"><i class="fa fa-edit"></i>Modification direction</span>
                        </div>
                        <!-- end .panel-heading section -->

                        <form method="post" action="admin/organisation/direction/add.php" id="comment" enctype="multipart/form-data">
                                ...
                                <div class="section row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="direction_new" name="direction_new" class="form-control required br-dark" type="text">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <h5 class="m1 text-danger">Modifier le manager de la direction</h5>
                    ...
                    <input type="hidden" value="" name="id_direction" id="id_direction" />
                    <input type="hidden" value="" name="direction_old" id="direction_old" />
        ...
        <!-- BEGIN: PAGE SCRIPTS -->
        <script>
            var CONTEXT_MSG_ADD_DIRECTION = '<% if (session.getAttribute("isAddDirection") != null) {
                    out.print(session.getAttribute("isAddDirection").toString());
                    session.removeAttribute("isAddDirection");
                }%>';
        </script>
        <!-- jQuery -->
        ...
        <script type="text/javascript">
            jQuery(document).ready(function () {
                ...
                if (CONTEXT_MSG_ADD_DIRECTION !== "") {

                    var $noteStyle = '';
                    var $msg = '';
                    if (CONTEXT_MSG_ADD_DIRECTION === "-1") {
                        $noteStyle = "danger";
                        $msg = "L'Employé est deja manager";
                    } else if (CONTEXT_MSG_ADD_DIRECTION === "1") {
                        $noteStyle = "success";
                        $msg = "Direction ajoutée avec succès!!!";
                    }

                    new PNotify({
                        title: 'Enregistrement direction',
                        shadow: true,
                        text: $msg,
                        type: $noteStyle,
                        width: "290px",
                ...
                $.magnificPopup.open({
                    ...
                    callbacks: {
                        beforeOpen: function (e) {
                            ...
                            $("#id_direction").val($id);
                            $("#direction_old").val($lib);
                            $("#direction_new").val($lib);
                            $("#manager_old").val($man);
                            $("#idManager").val($man_id);
                                                        
                            $('#modal-form-direction #manager').val("");
                            $('#modal-form-direction #nom').val("");
                            $('#modal-form-direction #prenom').val("");
