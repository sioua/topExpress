...
--%>
                            <li class="active">
                                <a href="javascript:void(0);">Ajouter un employé</a>
                            </li>
                            <%--<li>
                ...
                <section id="content" class="table-layout animated fadeIn">
                    ...
                    <div class="panel mb25 mt5">
                        <div class="panel-heading">
                            <span class="panel-title"> Ajouter un employé</span>
                        </div>
                        <div class="panel-body p20 pb10">
                            <div class="tab-content pn br-n admin-form">
                                <form action="admin/organisation/employe/add.php" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="action" value="organisation" />
                                <input type="hidden" name="section" value="employe" />
                                        ...
                                        <div class="col-md-9 pl15">
                                            ...
                                            <div class="section row mb15">
                                                ...
                                                <div class="col-xs-6">
                                                    <div class="form-group">
                                                        <label>Service *</label>
                                                        <select name='service' id="service" data-placeholder="Selectionnez le service..." class="chosen-select form-control" tabindex="2">
                                                            <option value=""></option>
                                                            <% for(OrgService o : listService){ %>
                                            ...
                                            <div class="section mb15">
                                                <label for="email" class="field prepend-icon">
                                                    <input type="text" name="email" id="email" class="event-name gui-input br-light bg-light" placeholder="Email">
                                            ...
                                            <div class="section mb15">
                                                <div class="form-group">
                                                    <button class="btn btn-sm btn-danger pull-left m-t-n-xs" type="submit"><strong>Enregistrer</strong></button>
                                                </div>
                                            </div>
