                ...
                <header id="topbar">
                    <div class="topbar-left">
                        <ul class="nav nav-list nav-list-topbar pull-left">
                            ...
                            --%>
                            <li class="active">
                                <a href="javascript:void(0);">Gestion des départements</a>
                            </li>
                            <%--<li>
                    ...
                    <div class="tray tray-center p25 va-t posr">
                        ...
                        <div class="panel mb25 mt5">
                            <div class="panel-heading">
                                <span class="panel-title"><span class="fa fa-car pr5"></span> Gestion des départements</span>
                                            ...
                                            <div class="col-md-12" style="margin-top: 10px;">
                                                ...
                                                <div class="panel" id="p13" data-panel-fullscreen="false" data-panel-title="false" data-panel-remove="false" data-panel-collapse="false">
                                                    <div class="panel-heading ui-sortable-handle">
                                                        <span class="panel-title"> Ajouter un département</span>
                                                ...
                                                <div class="panel" id="spy4">
                                                    <div class="panel-heading" style="padding:0;">
                                                        <span class="panel-title">
                                                            <span class="glyphicons glyphicons-table"></span>Liste des départements</span>
        ...
        <script type="text/javascript">
                jQuery(document).ready(function () {
                    ...
                    if (CONTEXT_MSG_ADD_DEPARTEMENT === "-1") {
                        $noteStyle = "danger";
                        $msg = "L'Employé est deja manager de département";
                    } else if (CONTEXT_MSG_ADD_DEPARTEMENT === "1") {
                        $noteStyle = "success";
                        $msg = "Departement ajoutée avec succès!!!";
                    }
