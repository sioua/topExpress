...
<html>
    ...
    <body class="dashboard-page sb-l-o sb-r-c">
        ...
        <%
            ...
            List<OrgService> listService = officeService.FindAll();
        ...
        <div id="main">
                ...
                <header id="topbar">
                    <div class="topbar-left">
                        <ul class="nav nav-list nav-list-topbar pull-left">
                            ...
                            --%>
                            <li class="active">
                                <a href="javascript:void(0);">Gestion des services</a>
                            </li>
                            <%--<li>
                                <a href="../vehicule/modele">Modèles</a>
                            </li>
                            <li>
                    ...
                    <div class="topbar-right">
                        <a href="admin/organisation/employe/add.php" class="btn btn-danger btn-sm fw600 ml10 btn-gradient btn-rounded"><span class="fa fa-plus pr5"></span> Employé</a>
                        <a href="admin/organisation/departement/list.php" class="btn btn-danger btn-sm fw600 ml10 btn-gradient btn-rounded"><span class="fa fa-plus pr5"></span> Département</a>
                ...
                <section id="content" class="table-layout animated fadeIn">
                    ...
                    <div class="tray tray-center p25 va-t posr">
                        ...
                        <div class="panel mb25 mt5">
                            <div class="panel-heading">
                                <span class="panel-title"><span class="fa fa-car pr5"></span> Gestion des services</span>
                                            ...
                                            <div class="col-md-12" style="margin-top: 10px;">
                                                ...
                                                <div class="panel" id="p13" data-panel-fullscreen="false" data-panel-title="false" data-panel-remove="false" data-panel-collapse="false">
                                                    <div class="panel-heading ui-sortable-handle">
                                                        <span class="panel-title"> Ajouter un service</span>
                                                        <span class="panel-controls"><a href="#" class="panel-control-loader"></a><a href="#" class="panel-control-color"></a></span></div>
                                                    <div class="panel-body">
                                                        <form method="post" action="admin/organisation/service/list.php">

                                                            <div class="row">
                                                                <div class="col-md-4"> 
                                                                    <h6 style="margin: 0; margin-bottom: 10px;">Les champs précédés du caractère astérisque (*) sont obligatoires</h6>
                                                                    <div class="row">
                                                                        <div class="form-group">
                                                                            <label>Service *</label>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <select name="dept" id="dept" class="chosen-select form-control">
                                                                                <option value=""> </option>
                                                                                <% for (OrgDepartement o : listDepartement) {%>
                                                                ...
                                                                <div class="col-md-offset-1 col-md-7" style="background-color: #EBE8E8;">
                                                                <div>
                                                ...
                                                <div class="panel" id="spy4">
                                                    <div class="panel-heading" style="padding:0;">
                                                        <span class="panel-title">
                                                            <span class="glyphicons glyphicons-table"></span>Liste des services</span>
                                                                    ...
                                                                    <tr class="text-center">
                                                                        ...
                                                                        <td>
                                                                            <%
                                                                                try {
                                                                                    if (mo.getId() != null) {
                                                                                        out.println(mo.getDepartement().getLibelle());
                                                                                    }
                                                                                } catch (Exception e) {
                                                                                }
                                                                            %>
                                                                        ...
                                                                        <td>
                                                                            <button type="button" class="btn btn-xs btn-default active-animation" ref-id="<%= mo.getId() %>" ref-lib="<%= mo.getLibelle() %>"  ref-man="<% if(mo.getChef()!=null){out.print(mo.getChef().getNom()+" "+mo.getChef().getPrenom());} %>" ref-man-id="<% if(mo.getChef()!=null){out.print(mo.getChef().getId());} %>"  ref-dir="<% if(mo.getDepartement()!=null){out.print(mo.getDepartement().getId());} %>" ref-man-id="<% if(mo.getChef()!=null){out.print(mo.getChef().getId());} %>" ref-form="#modal-form-service" data-effect="mfp-sign"><i class="fa fa-edit"></i>
                                                                            </button>
                                                                        </td>
                    ...
                    <aside class="tray tray-right tray290 va-t pn" data-tray-height="match">
                        ...
                        <div class="p20 admin-form">
                            ...
                            <h4 class="mt5 text-muted fw500"> Rechercher un employé</h4>
                            ...
                            <h6 class="fw400">Nom de l'employé</h6>
                            <div class="section mb10">
                                <label for="customer-id" class="field prepend-icon">
                                    <input type="text" name="customer-id" id="customer-id" class="gui-input" placeholder="">
                                    <label for="customer-id" class="field-icon"><i class="fa fa-user"></i>
            ...
            <div class="row">
                ...
                <div id="modal-form-service" class=" popup-basic admin-form mfp-with-anim mfp-hide" style="width:550px; max-width: none;">
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title"><i class="fa fa-edit"></i>Modification service</span>
                        </div>
                            ...
                            <div class="panel-body p25">
                                ...
                                <div class="section row">
                                    <div class="col-md-6">
                                         <div class="form-group">
                                            <label>Service</label>
                                            <input id="service_new" name="service_new" class="form-control required br-dark" type="text">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label>Département</label>
                                            <select class="form-control" id="departement_old" name="departement_old">
                                                <% for (OrgDepartement o : listDepartement) {%>
                                                    <option value="<%= o.getId()%>"><%= o.getLibelle()%> </option>
                                                <% }%>
                                            </select>
                    ...
                    <input type="hidden" value="" name="id_service" id="id_service"></input>
                    <input type="hidden" value="" name="service_old" id="service_old"></input>
                    ...
                    <input name="section" value="service" type="hidden">
        ...
        <!-- BEGIN: PAGE SCRIPTS -->
        <script>
            var CONTEXT_MSG_ADD_SERVICE = '<% if (session.getAttribute("isAddService") != null) {
                    out.print(session.getAttribute("isAddService").toString());
                    session.removeAttribute("isAddService");
                }%>';
        </script>
        <!-- jQuery -->
        ...
        <script type="text/javascript">
            jQuery(document).ready(function () {
                ...
                if (CONTEXT_MSG_ADD_SERVICE !== "") {

                    var $noteStyle = '';
                    var $msg = '';
                    if (CONTEXT_MSG_ADD_SERVICE === "-1") {
                        $noteStyle = "danger";
                        $msg = "L'Employé est deja manager de service";
                    } else if (CONTEXT_MSG_ADD_SERVICE === "1") {
                        $noteStyle = "success";
                        $msg = "Service ajoutée avec succès!!!";
                    }

                    new PNotify({
                        title: 'Enregistrement service',
                        shadow: true,
                        text: $msg,
                        type: $noteStyle,
                        width: "290px",
                ...
                $.magnificPopup.open({
                    ...
                    callbacks: {
                        beforeOpen: function (e) {
                            ...
                            $('#departement_old option[value="'+$dir+'"]').prop('selected', true);
                            
                            $('#modal-form-service #manager').val("");
                            $('#modal-form-service #nom').val("");
                            $('#modal-form-service #prenom').val("");
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data.isValid) {
                                ...
                                if (data.result === "-1") {
                                    $msg = "Employé non trouvé";
                                    $noteStyle = "danger";
                                } else if (data.result === "0") {
                                    $msg = "Employé déjà manager";
                                    $noteStyle = "warning";
