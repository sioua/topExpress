...
<html>
    ...
    <body class="dashboard-page sb-l-o sb-r-c">
        ...
        <%
            ...
            List<Garage> listGarage = garageService.FindAll();
...
<jsp:include page="../../../imports/main/menu_admin.html" >
                ...
                <header id="topbar">
                    <div class="topbar-left">
                        <ul class="nav nav-list nav-list-topbar pull-left">
                            ...
                            --%>
                            <li class="active">
                                <a href="javascript:void(0);">Modèles</a>
                            </li>
                            <%--<li>
                    ...
                    <div class="topbar-right">
                        ...
                        <a href="../parameter/contrat" class="btn btn-danger btn-sm fw600 ml10 btn-gradient btn-rounded"><span class="fa fa-list pr5"></span> Contrat vehicule</a>
                        <a href="../parameter/site" class="btn btn-danger btn-sm fw600 ml10 btn-gradient btn-rounded"><span class="fa fa-list pr5"></span> Site d'affectation</a>
                    </div>
                    ...
                    <div class="tray tray-center p25 va-t posr">
                        ...
                        <div class="panel mb25 mt5">
                            <div class="panel-heading">
                                <span class="panel-title"><span class="fa fa-car pr5"></span> Gestion des garages</span>
                                                ...
                                                <div class="col-md-4" style="margin-top: 10px;">
                                                    ...
                                                    <div class="panel" id="p13" data-panel-fullscreen="false" data-panel-title="false" data-panel-remove="false" data-panel-collapse="false">
                                                        <div class="panel-heading ui-sortable-handle">
                                                            <span class="panel-title"> Ajouter un garage au parc</span>
                                                            <span class="panel-controls"><a href="#" class="panel-control-loader"></a><a href="#" class="panel-control-color"></a></span></div>
                                                        <div class="panel-body">
                                                           
                                <form action="manager/garage/add.php" method="post">
                                    
                                                            <h6 style="margin: 0;">Les champs précédés du caractère astérisque (*) sont obligatoires</h6>
                                                                
                                                                <div class="form-group">
                                                                    <label>Nom du garage *</label>
                                                                    <input id="garage" name="garage" type="text" class="form-control required">
                                                                </div>
                                                                <div class="form-group">
                                                                    <label>Localisation *</label>
                                                                    <textarea id="localisation" name="localisation" type="text" class="form-control required"></textarea>
                                                                </div> 
                                                                <div class="form-group">
                                                                    <button class="btn btn-sm btn-primary pull-right m-t-n-xs" type="submit"><strong>Enregistrer</strong></button>
                                                                </div>
                                        <input type="hidden" name="action" value="garage" />
                                    <input type="hidden" name="section" value="garage" />
                                                    ...
                                                    <div class="panel" id="spy4">
                                                        <div class="panel-heading" style="padding:0;">
                                                            <span class="panel-title">
                                                                <span class="glyphicons glyphicons-table"></span>Liste des garages</span>
                                                                ...
                                                                <table class="table table-bordered mbn" id="datatable2">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            try{
                                                                                if(mo.getId()!=null){
                                                                                    out.println(mo.getLocalisation());
                                                                                }
                                                                            }catch(Exception e){   
                                                                            }
                                                                            %>
                                                                            ...
                                                                            <td>
                                                                                <button type="button" class="btn btn-xs btn-default active-animation" ref-id="<%= mo.getId() %>" ref-lib="<%= mo.getLibelle() %>" ref-loc="<%= mo.getLocalisation() %>" ref-form="#modal-form-garage" data-effect="mfp-sign"><i class="fa fa-edit"></i>
                                                                            </button>
                                                                            </td>
                                                                        </tr>
                                                                         <% i++; %>
            ...
            <div class="row">
                ...
                <div id="modal-form-garage" class=" popup-basic admin-form mfp-with-anim mfp-hide" style="width:350px; max-width: none;">
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title"><i class="fa fa-edit"></i>Modification du garage</span>
                        </div>
                        <!-- end .panel-heading section -->

                        <form method="post" action="manager/garage/add.php" id="comment" enctype="multipart/form-data">
                            <div class="panel-body p25">
                                ...
                                <div class="section row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Ancienne localisation</label>
                                            <input id="localisation_old" name="localisation_old" class="form-control required br-dark" readonly="true" type="text">
                                        </div>
                                    </div>
                                    <div class="col-md-12 form-group">
                                        <label>Status</label>
                                        <select name="active" class="form-control br-dark">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label style="color: #E9573F;">Nouvelle localisation</label>
                                            <input id="localisation_new" name="localisation_new" class="form-control required br-dark" type="text" />
                                        </div>
                                    </div>
                                </div>
                    ...
                    <input type="hidden" value="" name="id_garage" id="id_garage">
                    <input type="hidden" name="action" value="garage" />
                    <input type="hidden" name="section" value="garage" />
