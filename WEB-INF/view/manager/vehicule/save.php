            ...
            <section id="content_wrapper">
                ...
                <header id="topbar">
                    ...
                    <div class="topbar-right">
                        <a href="list.php" class="btn btn-danger btn-sm fw600 ml10 btn-gradient btn-rounded"><span class="fa fa-list pr5"></span> Accéder à la liste véhicule</a>
                    </div>
                                    ...
                                    <div id="tab1_1" class="tab-pane active">
                                        ...
                                        <div class="section row mbn">
                                            ...
                                            <form id="form" action="saveVehicule.php" method="post" class="wizard-big">
                                                ...
                                                <fieldset>
                                                    <h5 style="margin: 0;">Caractéristiques du véhicule</h5>
                                                    <h6 style="margin: 0;">Les champs précédés du caractère astérisque (*) sont obligatoires</6>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6" style="margin-top: 10px;">
                                                                ...
                                                                <div class="form-group">
                                                                    <label>Energie *</label>
                                                                    <select id="energie" name="energie" data-placeholder="Selectionnez la société..." class="chosen-select form-control" tabindex="2">
                                                                        <option value=""></option>
                                                    ...
                                                    <h6 style="margin: 0;">Les champs précédés du caractère astérisque (*) sont obligatoires</h6>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6" style="margin-top: 10px;">
                                                                ...
                                                                <label class="control-label mb15">Catégorie véhicule</label>
