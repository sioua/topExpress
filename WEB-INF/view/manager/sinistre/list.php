                ...
                <section id="content" class="table-layout animated fadeIn">
                    ...
                    <div class="tray tray-center p25 va-t posr">
                        ...
                        <div class="panel mb25 mt5">
                            <div class="panel-heading">
                                <span class="panel-title"><span class="fa fa-car pr5"></span> Liste des véhicules en mission</span>
                    ...
                    <aside class="tray tray-right tray290 va-t pn" data-tray-height="match">
                        ...
                        <div class="p20 admin-form">
                            ...
                            <h6 style="color:#000;" class="mbn mtn">Permet de retrouver les missions clôturés</h6>
                            <hr class="short">
                        ...
                        <form method="post" action="manager/mission/list.php" id="comment" enctype="multipart/form-data">
                            <div class="panel-body p25">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Kilométrage d'arrivé</label>
