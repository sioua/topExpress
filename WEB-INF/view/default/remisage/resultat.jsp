...
<html>
    ...
    <body class="dashboard-page sb-l-o sb-r-c">
        ...
        <%
            if(session.getAttribute("isRemisage")==null){
                response.sendRedirect(request.getContextPath()+"/default/remisage/create");
            }
                ...
                <section id="content" class="table-layout animated fadeIn">
                    ...
                    <div class="tray tray-center p25 va-t posr">
                        ...
                        <div class="row">
                            ...
                            <h3>Enregistrement de remisage</h3>
                            <p>Opération effectuée avec succès.</p>
                            <p>N° Dossier : <span style="font-size: 24px;"><%= session.getAttribute("dossier").toString() %></span></p>
                        </div>
