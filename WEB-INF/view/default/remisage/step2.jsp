                ...
                <section id="content" class="table-layout animated fadeIn">
                    ...
                    <div class="tray tray-center p25 va-t posr">
                        ...
                        <div class="panel mb25 mt5">
                            <div class="panel-heading">
                                <span class="panel-title"><span class="fa fa-car pr5"></span> Gestion des Remisages : Validation manager</span>
                            ...
                            <div class="panel-body p20 pb10">
                                ...
                                <div class="tab-content pn br-n admin-form">
                                    ...
                                    <div id="tab1_1" class="tab-pane active">
                                        ...
                                        <form action="manager/remisage/create" method="post" id="crud-form">
                                                ...
                                                <div class="col-md-12" style="margin-top: 10px;">
                                                    ...
                                                    <%--
                                                                                                        <div class="row" style="border-top: 1px solid #2c2c2c;">
                                                                                                            ...
                                                                                                            <div class="col-md-4">
                                                                                                                <label class="text-muted">Veuillez joindre le document de remisage signé</label>
                                                                                                            </div>
                                                                                                            <div class="col-md-8">
                                                    ...
                                                    <div class="row mt10 pt5" style="border-top: 1px solid #2c2c2c;">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <a class="btn btn-sm btn-dark pull-left m-t-n-xs" attr-action="refus" onclick="onSubmitted($(this).attr('attr-action'))"><strong>Refuser</strong></a>
                                                                &nbsp;
                                                                <a class="btn btn-sm btn-dark pull-left m-t-n-xs"attr-action="valid" onclick="onSubmitted($(this).attr('attr-action'))"><strong>Valider</strong></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <input type="hidden" name="operation" value="condition" id="condition" />
                    ...
                    <aside class="tray tray-right tray290 va-t pn" data-tray-height="match">
                        ...
                        <div class="p20 admin-form">
                            ...
                            <h6 class="fw400">Carrossérie véhicule</h6>
